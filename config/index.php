...
<?php
    ...
    while ($categorie = $categorie0->fetch()) {
        ...
        while ($cat = $cat0->fetch()) {    
            ...
            echo '
                                    <li style="text-align: left;"><a href="categorie.php?index='.$cat['Id'].'&cat='.$cat['Grande'].'&token='.sha1($index_cat.time().$index_cat).'"><b>'.$cat['Nom'].'</b></a></li>
            '; 
            $index_cat++;
        }
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="owl-carousel owl-theme owl-testimonials" data-toggle="owl" 
                                ...
                                <blockquote class="testimonial" style="width: 100%; margin: 0px;">
                                    <img id="banner_image" src="image/banner22.jpg" alt="Image Desc">         
                                </blockquote>
                                <blockquote class="testimonial" style="width: 100%; margin: 0px;">
                                    <img src="image/banner_drones2.png" alt="Image Desc">         
                                </blockquote>
                                 <blockquote class="testimonial" style="width: 100%; margin: 0px;">
                                    <img src="image/banner4.png" alt="Image Desc">         
                                </blockquote>
                            ...
                            <div class="intro-banners">
                                <div class="banner mb-lg-1 mb-xl-2">
                                    ...
                                    <div class="banner-content">
                                        <h4 class="banner-subtitle d-lg-none d-xl-block"><a href="boutique.php">Sécurisez vos</a></h4>

                                        <h3 class="banner-title"><a href="boutique.php">Systèmes <span> informatiques </span> </a></h3>
                                        <a href="" class="banner-link">Voir<i class="icon-long-arrow-right"></i></a>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="intro-banners">
                                ...
                                <div class="banner mb-lg-1 mb-xl-2">
                                    ...
                                    <div class="banner-content">
                                        <h4 class="banner-subtitle d-lg-none d-xl-block"><a href="boutique.php">Mettez en réseau</a></h4>

                                        <h3 class="banner-title"><a href="boutique.php">Tous vos appareils <span> informatiques </span> </a></h3>
                                        <a href="boutique.php" class="banner-link">Voir<i class="icon-long-arrow-right"></i></a>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4">
                            <div class="intro-banners">
                                ...
                                <div class="banner mb-0">
                                    ...
                                    <div class="banner-content">
                                        <h4 class="banner-subtitle d-lg-none d-xl-block"><a href="boutique.php">Nous assurons</a></h4>

                                        <h3 class="banner-title"><a href="boutique.php">la gestion de <span>vos projets</span></a></h3>
...
$select0 = $lock->query('SELECT art.*, cat.Nom AS Nom_cat FROM commerce_article AS art INNER JOIN commerce_categorie AS cat ON cat.Id = art.Categorie ORDER BY RAND() LIMIT 16 ');
                            ...
                            <div class="col-lg-6">
                                <div class="cta-wrapper cta-text text-center">
                                    ...
                                    <div class="social-icons social-icons-colored justify-content-center">
                                        ...
                                        <a style="background-color:#004f80e2;" href="https://www.facebook.com/profile.php?id=61559178477106&mibextid=LQQJ4d" class="social-icon social-facebook" title="Facebook" target="_blank"><i class="icon-facebook-f" ></i></a>
