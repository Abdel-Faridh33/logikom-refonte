...
if (isset($_POST['valider'])) {
    ...
    $modifie = $lock->prepare('UPDATE commerce_article SET Titre = ?, Categorie = ?, Prix_norm = ?, Reduction = ?, Prix_reduction = ?, Resume = ?, Description = ? WHERE Id = ? ');
    $modifie->execute(array( $_POST['titre'], $_POST['categorie'], $_POST['prix'], $_POST['pourcentage'], $prix_reduction, $_POST['resume'], $_POST['description'], $_POST['id_article'] ));


    header('Location: product.php?id_product='.$_POST['id_article']);
...
<head>
    ...
    <title> Modifier produit | Logikom </title>
...
<body>
    <div class="page-wrapper">
        <header class="header header-intro-clearance header-3" style="background-color: white;">
            ...
            <div class="header-top" style="background-color:#004f80e2;;">
                <div class="container">
                    ...
                    <div class="header-right">
                        ...
                        <div class="header-dropdown">
                            <a style="font-size: 15px;" href="mailto:<?php echo $para['Mail']; ?>"><i class="icon-envelope"></i> <?php echo $para['Mail']; ?>  </a>

                            <a style="font-size: 15px;" target="_blanc" href="https://maps.app.goo.gl/uYpBm5C98qdKbG5Y7"><i class="icon-map-marker"></i> <?php echo $para['Location']; ?>  </a>
...
<?php
    ...
    while ($categorie = $categorie0->fetch()) {
        ...
        if ( $categorie['Id'] == $selecte_produit['Categorie']) { $selected = "selected=selected"; }
        else { $selected = ""; }
        
        $elementCategorie .= '<option value="'.$categorie['Id'].'" '.$selected.'>'.$categorie['Nom'].'</option>';
    }
...
?>
	            						...
	            						<div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <input type="number" id="prix" name="prix" class="form-control" value="<?php echo $selecte_produit['Prix_norm']; ?>" required>
                                            </div><!-- End .col-sm-6 -->

                                            <div class="col-sm-6">
                                                <label>Pourcentage de réduction *</label>
                                                <input type="number" id="pourcentage" name="pourcentage" class="form-control" value="<?php echo $selecte_produit['Reduction']; ?>" required>
                                            </div><!-- End .col-sm-6 -->
                                        </div><!-- End .row -->
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <input type="hidden" id="id_article" name="id_article" value="<?php echo $selecte_produit['Id']; ?>" required>
