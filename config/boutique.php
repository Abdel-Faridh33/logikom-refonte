...
?>                                                  
        ...
        <main class="main" style="background-image: url(image/fond.jpg);">
        	<div class="page-header text-center" style="background-image: url('assets/images/page-header-bg.jpg')">
        		<div class="container">
        			<h1 class="page-title" style="font-family: algerian;"> Boutique </h1>
        		</div><!-- End .container -->
        	</div><!-- End .page-header -->
...
$select0 = $lock->query('SELECT * FROM commerce_article ORDER BY RAND() LIMIT 12 ');
