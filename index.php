...
<body>
    ...
    <div id="boutique" class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 text-center">
            ...
            <a href="boutique.php" class="bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 rounded-full transition-all duration-300 transform hover:scale-105 font-semibold inline-block">
                Voir la Boutique
            </a>
        </div>
    </div>
