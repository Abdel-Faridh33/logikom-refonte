...
<body>
    <main class="w-full overflow-hidden">
        ...
        <section class="bg-gray-800 text-white relative max-w-full  ">
            <div class="max-w-7xl mx-auto px-4 ">
                <div class="flex items-center space-x-1 w-full py-2">
                    <!-- Gradient fade sur la droite pour indiquer qu'il y a plus de catégories -->
                    <div class="absolute right-4 top-0 bottom-0 w-20 bg-gradient-to-l from-gray-800
                ...
                <div class="carousel-slide absolute inset-0 transition-opacity duration-700 opacity-0">
                    ...
                    <div class="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
                        <div class="text-center text-white px-4">
                            ...
                            <p class="text-xl md:text-2xl mb-6">Assurer-vous une meilleur liaison avec votre équipe et
                                vos
                                proches</p>
                            <a href="#products"
                                class="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-full transition-all duration-300 transform hover:scale-105 inline-block">
                ...
                <?php if ($selectedGrande > 0 || $selectedCategory > 0): ?>
                    <div class="mb-6 flex items-center text-sm text-gray-600">
                        ...
                        <?php if ($selectedGrande > 0):
                            ...
                            <a href="<?php echo urlWithParams('index.php', ['grande' => $selectedGrande]); ?>"
                    ...
                    <form method="GET" class="flex flex-col lg:flex-row gap-4 items-center justify-between">
                        ...
                        <div class="flex items-center gap-4">
                            <select name="sort" onchange="this.form.submit()"
                                ...
                                <option value="date" <?php echo $sortBy == 'date' ? 'selected' : ''; ?>>Plus récents
                                </option>
                            ...
                            <div onclick="window.location.href='<?php echo urlWithParams('produit.php', ['id' => $product['Id']]); ?>'"
                                ...
                                <div class="p-6">
                                    <div class="text-sm text-blue-600 mb-2">
                                        <?php echo htmlspecialchars($product['NomGrande']); ?> >
                                        <?php echo htmlspecialchars($product['NomCategorie']); ?>
                                    </div>
                                    <h3
