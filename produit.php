...
<body>
    ...
    <div class="py-20 bg-gray-50 min-h-screen">
        <div class="max-w-7xl mx-auto px-4">
            <!-- Back Button -->
            <a href="<?php echo url('index.php'); ?>" class="flex items-center space-x-2 text-blue-600 hover:text-blue-700 mb-8 transition-colors">
                        ...
                        <div class="flex space-x-4">
                            <?php foreach($images as $index => $image): ?>
                                <button onclick="changeMainImage('assets/images/article/<?php echo htmlspecialchars($image); ?>', this)"
                                    ...
                                    <img src="assets/images/article/<?php echo htmlspecialchars($image); ?>" alt="" class="w-full h-full object-cover">
                                </button>
                            <?php endforeach; ?>
                        </div>
                    <?php endif; ?>
